...
//
//    private final Logger log = LoggerFactory.getLogger(Attempt4.class.getPackage().getClass());
//
//    private FieldPath mana;
//    private FieldPath maxMana;
//    private FieldPath abilities;
//
...
//            abilities = e.getDtClass().getFieldPathForName("m_hAbilities");
//        }
//    }
//
//    @OnEntityCreated
...
//        }
//        ensureFieldPaths(e);
//        System.out.format("%s (%s/%s) - %s\n", e.getDtClass().getDtName(), e.getPropertyForFieldPath(mana), e.getPropertyForFieldPath(maxMana), e.getPropertyForFieldPath(abilities));
//    }
//
//    @OnEntityUpdated
...
//            if (updatedPaths[i].equals(abilities)/* || updatedPaths[i].equals(mana) || updatedPaths[i].equals(maxMana)*/) {
//                update = true;
//                break;
//            }
//        }
